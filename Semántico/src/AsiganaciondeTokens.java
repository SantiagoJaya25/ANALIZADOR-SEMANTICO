...
class AsiganaciondeTokens
{
	...
	public static String checkAsing(Token TokenIzq, Token TokenAsig)
	{
		...
		if(TokenIzq.kind != 45 && TokenIzq.kind != 47)		
		{
			...
			catch(Exception e)
			{
				...
				return "Error de tipo semantico : El identificador '" + TokenIzq.image + "' Aun no esta declarado \r\nLinea: " + TokenIzq.beginLine;
			}
		}
		else 		
			tipoIdent1 = 0;
		...
		if(TokenAsig.kind == 46)	
		{
			...
			catch(Exception e)
			{
				...
				return "Error de tipo Semantico : '" + TokenAsig.image + "' Aun no esta declarado \r\nLinea: " + TokenIzq.beginLine;
			}
		}
		...
		if(tipoIdent1 == 40) //Int
		{
			...
			if(intComp.contains(tipoIdent2))
				...
				return "Error de tipo Semantico: No se puede convertir '" + TokenAsig.image + "' a Entero \r\nLinea: " + TokenIzq.beginLine;
		}
		else if(tipoIdent1 == 41) //double
		{
			if(decComp.contains(tipoIdent2))
				...
				return "Error de tipo de Semantico: No se puede convertir '" + TokenAsig.image + "' a Decimal \r\nLinea: " + TokenIzq.beginLine;
		}
		else if(tipoIdent1 == 42) //char
		{
			...
			if(segunda < 2)
			{
				if(chrComp.contains(tipoIdent2))
					...
					return "Error de tipo Semantico : No se puede convertir " + TokenAsig.image + " a Caracter \r\nLinea: " + TokenIzq.beginLine;	
			}
		...
		else if(tipoIdent1 == 43) //string
		{
			if(strComp.contains(tipoIdent2))
				...
				return "Error de tipo Semantico : No se puede convertir " + TokenAsig.image + " a Cadena \r\nLinea: " + TokenIzq.beginLine;
		}
		else if(tipoIdent1 == 44) //bool
		{
			if(boolComp.contains(tipoIdent2))
				...
				return "Error de tipo Semantico : No se puede convertir " + TokenAsig.image + " a Booleano \r\nLinea: " + TokenIzq.beginLine;
		}
		else
		{
	...
	public static void visualizarTablas()
	{
		...
		Object obj;
		System.out.printf("\n%10s%6s%5s%6s", "TIPO DE TOKENS - TABLA \n","INDENTIFICADOR"," |","TIPO\n");
